...
export class AppComponent {
  public readonly books: Book[] = [
    ...
    },
    {
      ...
      pages: 328,
      coverUrl:
        'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1532714506l/40961427.jpg',
    },
    {
    ...
    },
    {
      ...
      pages: 310,
      coverUrl:
        'https://i.gr-assets.com/images/S/compressed.photo.goodreads.com/books/1372847500l/5907.jpg',
    },
    {
      title: 'The Alchemist',
      author: 'Paulo Coelho',
  ...
  public filteredBooks?: Book[] | null = null;
  ...
  public searchBook(): void {
    ...
    this.filteredBooks = this.books.filter((book) => {
      ...
      return (
        loweredTitle.includes(loweredPhrase) ||
        loweredAuthor.includes(loweredPhrase)
      );
    });
  }
